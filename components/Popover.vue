<template>
    ...
    <HPopover ref="popover" v-slot="{ open, close }" :class="ui.wrapper" v-bind="attrs" @mouseleave="onMouseLeave" class >
      <HPopoverButton
        ref="trigger"
        as="div"
        :disabled="true"
  ...
  import { usePopper } from '../ui/src/runtime/composables/usePopper'
  import { mergeConfig } from '../ui/src/runtime/utils'
  import type { PopperOptions, Strategy } from '../ui/src/runtime/types'
  // @ts-expect-error
